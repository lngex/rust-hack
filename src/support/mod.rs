...
use imgui_winit_support::winit::dpi::{PhysicalSize, Size};
    ...
    FUi: FnMut(&mut bool, &mut Ui) + 'static,
{
    ...
    let builder = WindowBuilder::new()
        .with_inner_size(Size::Physical(PhysicalSize{ width: 400, height: 400 }))
        .with_title(title);
...
pub fn create_context() -> imgui::Context {
    ...
    imgui.fonts().add_font(&[
        FontSource::TtfData {
            data: include_bytes!("../../resources/simsun.ttc"),
